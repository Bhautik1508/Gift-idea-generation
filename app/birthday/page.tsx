...
export const metadata: Metadata = {
  title: 'Birthday Gift Ideas — Personalised by GiftSense',
  description: 'Find the perfect birthday gift with AI-powered recommendations. Personalised ideas based on who they are, not generic lists.',
  keywords: ['birthday gifts', 'birthday gift ideas', 'personalised birthday gifts', 'unique birthday presents'],
};
  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center px-6 py-16 md:py-24">
      <main className="max-w-2xl w-full text-center">
        ...
        >
          A birthday gift that says
          <br />
          <span className="text-accent">&ldquo;I know you.&rdquo;</span>
        </h1>

        {/* Subline */}
        <p className="text-lg md:text-xl text-muted max-w-lg mx-auto mb-10 leading-relaxed">
          Forget the Amazon wishlist. Tell us about the person and we&apos;ll find a birthday gift that{' '}
          <span className="text-foreground font-medium">actually surprises them.</span>
        </p>

        {/* CTA */}
        <Link
          href="/gift/start?occasion=Birthday"
